...
{
	if (gstate.getUVGenMode() == GE_TEXMAP_TEXTURE_COORDS || gstate.getUVGenMode() == GE_TEXMAP_TEXTURE_MATRIX) {
		...
		Vec3<float> source;
		if (gstate.getUVProjMode() == GE_TEXMAP_TEXTURE_MATRIX) {
...
static inline Vec3<int> GetSourceFactor(int source_a, const Vec4<int>& dst)
{
	...
	case GE_SRCBLEND_INVDSTCOLOR:
		return Vec3<int>(255, 255, 255) - dst.rgb();

	case GE_SRCBLEND_SRCALPHA:
		return Vec3<int>(source_a, source_a, source_a);

	case GE_SRCBLEND_INVSRCALPHA:
		return Vec3<int>(255 - source_a, 255 - source_a, 255 - source_a);

	case GE_SRCBLEND_DSTALPHA:
		return Vec3<int>(dst.a, dst.a, dst.a);

	case GE_SRCBLEND_INVDSTALPHA:
		return Vec3<int>(255 - dst.a, 255 - dst.a, 255 - dst.a);

	case GE_SRCBLEND_DOUBLESRCALPHA:
		return 2 * Vec3<int>(source_a, source_a, source_a);

	case GE_SRCBLEND_DOUBLEINVSRCALPHA:
		return Vec3<int>(255 - 2 * source_a, 255 - 2 * source_a, 255 - 2 * source_a);

	case GE_SRCBLEND_DOUBLEDSTALPHA:
		return 2 * Vec3<int>(dst.a, dst.a, dst.a);

	case GE_SRCBLEND_DOUBLEINVDSTALPHA:
		return Vec3<int>(255 - 2 * dst.a, 255 - 2 * dst.a, 255 - 2 * dst.a);
...
static inline Vec3<int> GetDestFactor(const Vec3<int>& source_rgb, int source_a, const Vec4<int>& dst)
{
	...
	case GE_DSTBLEND_INVSRCCOLOR:
		return Vec3<int>(255, 255, 255) - source_rgb;
